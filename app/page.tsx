      ...
      <section className="bg-gradient-to-b from-[#EAF2FF] to-white py-16 md:py-24">
        <Container>
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div>
              <h1 className="text-4xl md:text-6xl font-bold leading-tight">生成AIの“結果を改善し続ける”評価プラットフォーム</h1>
              <p className="mt-5 text-lg text-neutral-600 max-w-xl">精度・コスト・応答速度をひとつの基準で見える化。パターン比較と専門担当者レビューを仕組み化し、「なぜ良くなったか」を再現可能にします。</p>
