  ...
  return (
    <footer className="w-full bg-neutral-900 text-neutral-300">
      <Container className="py-12">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="mt-2 space-y-1 text-sm">
              ...
              <li>
                <a href="mailto:hioki@aradia.asia" className="hover:underline">
                  hioki@aradia.asia
                </a>
              </li>
            </ul>
        ...
        <div className="pt-8 mt-8 border-t border-neutral-700 text-sm">
          © {new Date().getFullYear()} Monitly.AI Inc. All rights reserved.
        </div>
      </Container>
    </footer>
  );
